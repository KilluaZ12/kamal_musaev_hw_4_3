...
public class MainActivity extends AppCompatActivity implements OnItemClick{
    ...
    private void createArrayList() {
        ...
        products.add(new Product("Cucumber",
                ...
                R.drawable.cucumber, "150 som/kg", R.color.green));
        products.add(new Product("Watermelon",
                ...
                R.drawable.watermelon, "200 som/kg", R.color.green));
        products.add(new Product("Tomato",
                ...
                R.drawable.tomato, "120 som/kg", R.color.red));
        products.add(new Product("Strawberry",
                ...
                R.drawable.strawberry, "350 som/kg", R.color.red));
        products.add(new Product("Orange",
                ...
                R.drawable.orange, "180 som/kg", R.color.orange));
        products.add(new Product("Carrot",
                ...
                R.drawable.carrot, "45 som/kg", R.color.orange));
